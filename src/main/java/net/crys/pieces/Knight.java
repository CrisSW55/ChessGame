...
public class Knight extends ChessPiece{
    ...
    public Knight(String pos,Color color,ChessPieceType type) {
        super(pos,color,type);
        id = 2;
    }

    public Knight(int x, int y, int width, int height, GamePanel gamePanel) {
    ...
    public void loadImg() {
        //Black Rook
        if(y == 0) {
            img = temp.getSubimage(3 * gamePanel.getDefaultTileSize(),
